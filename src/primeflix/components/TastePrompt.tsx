...
const PACKS: Record<Domain, QuestionPack> = {
  movie: {
    ...
    themeChoices: [
      ...
      { label: "Horror · Dread", themes: ["horror", "occult", "dread"] },
      { label: "Animation · Color", themes: ["animation", "adventure", "color"] },
      { label: "Crime · Drama", themes: ["crime", "drama", "family"] },
      { label: "Mystery · Detective", themes: ["mystery", "detective", "twist"] },
      { label: "Fantasy · Epic", themes: ["fantasy", "epic", "adventure"] },
      { label: "Documentary · Real", themes: ["documentary", "focus", "exploration"] },
      { label: "Musical · Romance", themes: ["musical", "romance", "melancholy"] },
      { label: "Comedy · Warm", themes: ["comedy", "warmth", "satire"] },
    ],
    genreChoices: [
      "Any", "Sci-Fi", "Thriller", "Action", "Romance", "Drama",
      "Horror", "Animation", "Crime", "Mystery", "Fantasy",
      "Documentary", "Musical", "Comedy", "Noir",
    ],
